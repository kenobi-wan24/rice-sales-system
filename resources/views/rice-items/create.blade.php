    ...
    <div class="col-md-7">
        <div class="card shadow-sm">
            <div class="card-header bg-success text-white fw-bold">
                <i class="bi bi-plus-circle me-2"></i>Add New Rice Item
            </div>
            <div class="card-body">
                <form action="{{ route('rice-items.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" placeholder="e.g. Jasmine, Brown, Dinorado">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="stock_quantity" step="0.01"
                               ...
                               value="{{ old('stock_quantity') }}" placeholder="0.00">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="3"
                                  ...
                                  placeholder="Brief description of this rice variety">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
