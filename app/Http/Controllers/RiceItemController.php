...
class RiceItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rice-items.index')->with('success', 'Rice item added successfully.');
    }
    ...
    public function update(Request $request, RiceItem $riceItem)
    {
        ...
        return redirect()->route('rice-items.index')->with('success', 'Rice item updated successfully.');
    }

    public function destroy(RiceItem $riceItem)
    {
        $riceItem->delete();
        return redirect()->route('rice-items.index')->with('success', 'Rice item deleted successfully.');
    }
}